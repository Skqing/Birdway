/**
 * kitjs模板，整合了知名模板 mustache.js
 * @class $Kit.Template
 * @requires kit.js
 * @see <a href="https://github.com/janl/mustache.js/blob/master/mustache.js">Source code</a>
 * @example <a href="http://mustache.github.com/mustache.5.html">Mustache官网example</a>
 * <a href="http://xueduany.github.com/KitJs/KitJs/demo/Template/demo.html">KitJsexample</a>
 */
$Kit.Template = function() {
	/*!
...
/**
 * $Kit.Template的实例，直接通过这个实例访问$Kit.Template所有方法
 * @global
 * @alias $kit.template
 * @type $Kit.Template
 */
$kit.template = new $Kit.Template();
